...
test_car = cv2.resize(test_car, (50, 50))
test_car = np.array(test_car).reshape(-1, 50, 50, 1)
...
def cnn():
    ...
    # First hidden layer
    convnet = conv_2d(convnet, 32, 12, activation="relu")
    ...
    # Third hidden layer
    convnet = conv_2d(convnet, 128, 12, activation="relu")
    convnet = max_pool_2d(convnet, 5)
